                  ...
                  <tr className="w-100" key={i}>
                          ...
                          <tr>
                            ...
                            <td>
                              <img
                                src={val.img1}
                                alt="No"
                                className="cart-img-details"
                              />
                            </td>
                            <td className="ps-3">
                              <Link
                                to={`/${val.id}`}
                                className="text-decoration-none text-truncate text-dark fw-semibold cart-title-hover"
                              >
                                {val.title}
                              </Link>
                    ...
                    <td className="pt-4">
                      <span
                        className={
                          val.discountPrice
                            ? "cart-discount-price fw-semibold justify-content-center "
                            : "d-none"
                        }
                      >
                        ${val.discountPrice}
                      ...
                      <span
                        className={
                          !val.discountPrice
                            ? "cart-without-price justify-content-center"
                            : "cart-before-price"
                        }
                      >
                        ${val.price}
                    ...
                    <td className="pt-3">
                      <div className="input-group input-group-qty justify-content-center text-align-center align-items-center ">
                        <button
                          type="button"
                          className="btn rounded-0 border-0 cart-qty-btn"
                          onClick={() => {
                    ...
                    <td className="pt-4">
                      <strong>
                        $
                        {val.discountPrice
                          ? (val.discountPrice * val.quantity).toFixed(2)
                  ...
                  <Row className="justify-content-between mx-0 py-2 align-items-center">
                    <div className="col-4">
                      <Link
                        to={"/shop"}
                        type="button"
                        className="btn text-decoration-none rounded-2 cart-continue p-2 text-white bg-dark fw-semibold "
                      >
                        <strong>
                          <FaArrowLeft size={"12px"} /> Continue Shopping
                        </strong>
                      </Link>
                    </div>
                    <div className="col-5">
                    ...
                    <div className="col-3 text-uppercase">
                      Total Price :{" "}
                      <span className="fw-semibold cart-total-amount">
              ...
              <tr>
                <td className="border-0 pt-4" colSpan={5}>
                  <Link
                    to={"/checkout"}
                    type="button"
                    className="btn rounded-1 border-0 text-light bg-dark w-50 py-2 px-4 my-3 fs-6 cart-continue"
                  >
            ...
            <tbody>
              <tr>
                <td colSpan={4} className="text-center pt-4 border-0">
                  ...
                  <Link
                    className="text-decoration-none text-white bg-dark btn rounded-1 border-0 cart-continue"
                    to={"/shop"}
                  >
                    Continue Shopping
                  </Link>
