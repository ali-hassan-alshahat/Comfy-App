          ...
          <div className="collapse navbar-collapse " id="navbarSupportedContent">
            <ul className='m-0 p-0 nav-ul navbar-nav mx-auto'>
              <li className="ps-2 nav-item">
                <Link to={"/"} className={pathname === "/" ? 'nav-li active fs-5 fw-medium nav-link ': 'nav-li fs-5 fw-medium nav-link '}>
                Home
                </Link>
              </li>
              <li className="ps-2 nav-item">
                <Link to={"/shop"} className={pathname === "/shop" ? 'nav-li active fs-5 fw-medium nav-link ': 'nav-li fs-5 fw-medium nav-link '}>
                Shop
                </Link>
              </li>
              <li className="ps-2 nav-item">
                <Link to={"/about"} className={pathname === "/about" ? 'nav-li active fs-5 fw-medium nav-link ': 'nav-li fs-5 fw-medium nav-link '}>
                About
                </Link>
              </li>
              <li className="ps-2 nav-item">
                <Link to={"/contact"} className={pathname === "/contact" ? 'nav-li active fs-5 fw-medium nav-link ': 'nav-li fs-5 fw-medium nav-link '}>
                Contact
                </Link>
              </li>
              <li className="ps-2 nav-item">
                <Link to={"/FAQ"} className={pathname === "/FAQ" ? 'nav-li active fs-5 fw-medium nav-link ': 'nav-li fs-5 fw-medium nav-link '}>
                FAQ
                </Link>
              </li>
            </ul>
