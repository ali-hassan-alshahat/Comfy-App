  ...
  return (
    <div className='pt-5'>
      <div className='footer-background pt-5'>
            ...
            <div className='col-12 col-md-6 col-lg-4 mb-4 px-5'>
              <div className='footer-first-box'>
                ...
                <div className='footer-text pt-2'>
                  <p>
                    Since 2013 we’ve been creating industrial design,
                    residential architecture, commercial interiors. Chase mice
                    attack feet but rub face on everything cepteur sint occaecat
                    cupidatat proident.
                  </p>
                  <h6>Follow Us</h6>
                </div>
                <div className='footer-icons'>
                  ...
                  <a href='/' aria-label='github' className='me-3'>
                    <FaGithub size={"26px"} />
                  </a>
                </div>
              </div>
        ...
        <div className='border-top pt-4 pb-4 footer-copyright text-center'>
          &copy; Copyright 2023 Comfy Store. All Rights Reserved. Design By
          Team3-ITI
        </div>
      </div>
    </div>
